	...
	<div class="row" style="background-color: red;">
		...
		<div class=" col-md-2 ">
			<div class="btn-group ">
				...
				<ul class="dropdown-menu ">
					<li><a onclick="checkleixing1()">公开</a></li>
					<li><a onclick="checkleixing2()">私有</a></li>
					<li><a onclick="checkleixing3()">分享</a></li>
				</ul>
			</div>
		</div>
	...
	<div>
		...
		<div class="col-md-10">
			<table class="table table-hover">
				...
				<tbody>
					<c:forEach items="${sessionScope.liM}" var="each" varStatus="st">
						<tr>
							<td>${st.index+1}</td>
							<td>${each.filename}</td>
							<td>${each.leixing}</td>
