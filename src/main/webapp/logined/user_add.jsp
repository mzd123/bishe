...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<h1>${sessionScope.userF.nicheng}</h1>
			</div>
			<div class="col-md-4"></div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6" style="background-color:">
				<div class="form-group">
					...
					<div class="col-md-7">${sessionScope.userF.nicheng}</div>
				</div>
				...
				<div class="form-group" style="height: 45px;"></div>
				<div class="form-group">
					<label class="col-md-3 control-label">个&nbsp;&nbsp;性&nbsp;&nbsp;签&nbsp;&nbsp;名&nbsp;&nbsp;：</label>
					<div class="col-md-7">${sessionScope.userF.qianming}</div>
				</div>
				<div class="form-group " style="height: 45px;"></div>
				<div class="form-group">
					<label class="col-md-3 control-label">分&nbsp;&nbsp;享&nbsp;&nbsp;数&nbsp;&nbsp;目&nbsp;&nbsp;：</label>
				...
				<div class="form-group">
					...
					<div class="col-md-4" style="margin: 0px 0px 0px -30px">
						<button type="button" class="btn btn-primary"
							style="width: 155px;">
							<a
								href="<%=basePath%>addmyfriend.do?fnicheng=${sessionScope.userF.nicheng}"
