			...
			<div class="row">
				...
				<div class="col-md-8" id="yi">
					...
					<div class="col-md-2">
						...
						<a onclick="fond()" style="text-decoration: none;"> <font
							size="5" style="color: #FFFFFF;">发现</font>
						</a>
					</div>
					<div class="col-md-2">
						<div style="height: 30px;"></div>
					...
					<div class="col-md-2">
						<div style="height: 30px;"></div>
						<a onclick="advice()" style="text-decoration: none;"> <font
